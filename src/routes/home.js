...
router.get('/home', ensureAuthenticated,(req, res) => {
  var theme = jsonfile.readFileSync(themes);
    var options = {
        method: 'GET',
        url: `https://discord.gg/invite/zhsecurity`,
        headers: {
      ...
      request(options, function (error, response, body) {
        ...
        {
          console.log(chalk.red("Failed to check for updates you may continue using this version, please try again or contact Diego Saade#9999"))
          verL = ver.ver
        }
